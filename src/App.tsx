...
import { generateWeeklyWrapVideo } from "./utils/videoGenerator";
...
export default function App() {
  ...
  // Generate video from Weekly Wrap content
  const handleGenerateVideo = async () => {
    setGeneratingVideo(true);
    setVideoProgress(0);

    try {
      // Get all slide elements from the Weekly Wrap modal
      const slideElements = document.querySelectorAll<HTMLElement>('.weekly-wrap-slide');

      if (slideElements.length === 0) {
        throw new Error('No slides found');
      }

      const videoBlob = await generateWeeklyWrapVideo(Array.from(slideElements), (progress) => {
  ...
  const handleDownloadVideo = () => {
    if (videoUrl) {
      ...
      a.href = videoUrl;
      a.download = `weekly-wrap-${new Date().toISOString().split('T')[0]}.webm`;
                      ...
                      <div className="flex flex-col h-full justify-between min-h-[280px]">
                        ...
                        <div className="mt-6 flex items-center justify-between">
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              setShowWeeklyWrapModal(true);
                              // Wait for modal to render slides, then generate video
                              setTimeout(() => handleGenerateVideo(), 100);
                            }}
                            className="px-4 py-2 bg-white text-indigo-600 rounded-lg font-medium text-sm hover:bg-white/90 transition-all shadow-md flex items-center gap-2"
                          >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
        ...
        {generatingVideo && (
          <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/80">
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-12 text-center">
              <svg className="animate-spin w-16 h-16 mx-auto mb-6 text-white" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
              <h3 className="text-3xl font-bold text-white mb-2">Generating Your Video</h3>
              <p className="text-white/70 text-lg mb-4">This will take a moment...</p>
              <div className="text-4xl font-black text-white">{videoProgress}%</div>
            </div>
          </div>
        )}
        ...
        <div className="w-full max-w-2xl h-[600px] overflow-y-auto px-4">
          <div className="space-y-6">
            ...
            <div className="weekly-wrap-slide bg-gradient-to-br from-purple-600 via-pink-500 to-orange-500 rounded-3xl p-12 min-h-[500px] flex flex-col justify-center items-center text-center shadow-2xl">
              <div className="mb-8">
                <div className="text-white/80 text-xl font-medium mb-4">Your Week in Review</div>
                <h2 className="text-7xl font-black text-white mb-6">{getCurrentWeekRange().formatted}</h2>
            ...
            {/* Slide 2: Top Event */}
            <div className="weekly-wrap-slide bg-gradient-to-br from-blue-600 via-cyan-500 to-teal-500 rounded-3xl p-12 min-h-[500px] flex flex-col justify-center text-center shadow-2xl">
            ...
            <div className="weekly-wrap-slide bg-gradient-to-br from-green-600 via-emerald-500 to-teal-600 rounded-3xl p-12 min-h-[500px] flex flex-col justify-center shadow-2xl">
            ...
            <div className="weekly-wrap-slide bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 rounded-3xl p-12 min-h-[500px] flex flex-col justify-center shadow-2xl">
            ...
            {/* Slide 5: Closing */}
            <div className="weekly-wrap-slide bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-12 min-h-[500px] flex flex-col justify-center items-center text-center shadow-2xl">
            ...
            {/* Generate Video Card */}
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-12 min-h-[500px] flex flex-col justify-center items-center text-center shadow-2xl border-2 border-white/10">
              <div className="mb-8">
                ...
                <p className="text-white/70 text-xl max-w-md mx-auto">
                  Turn your weekly wrap into a shareable video at 1920x1080 resolution
                </p>
              </div>
              <button
                onClick={handleGenerateVideo}
                disabled={generatingVideo}
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 disabled:from-gray-600 disabled:to-gray-700 text-white px-12 py-5 rounded-full font-bold text-xl transition-all shadow-2xl hover:shadow-indigo-500/50 hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed"
              >
                Generate Video
              </button>
            </div>
    ...
    {videoUrl && (
      <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/95 backdrop-blur-sm">
        <div className="w-full max-w-6xl px-4">
          {/* Header */}
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white">Your Weekly Wrap Video</h2>
            <div className="flex items-center gap-3">
              <button
          ...
          <p className="text-white/60 text-sm text-center mt-4">
            Video generated at 1920x1080 • 30fps • WebM format
          </p>
        </div>
      </div>
    )}
